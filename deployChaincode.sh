...
export PEER0_ORG1_CA=${PWD}/artifacts/channel/crypto-config/peerOrganizations/customer.ibo.com/peers/peer0.customer.ibo.com/tls/ca.crt
export PEER0_ORG2_CA=${PWD}/artifacts/channel/crypto-config/peerOrganizations/org2.ibo.com/peers/peer0.org2.ibo.com/tls/ca.crt
...
setGlobalsForOrderer() {
    ...
    export CORE_PEER_TLS_ROOTCERT_FILE=${PWD}/artifacts/channel/crypto-config/ordererOrganizations/ibo.com/orderers/orderer.ibo.com/msp/tlscacerts/tlsca.ibo.com-cert.pem
...
setGlobalsForPeer0Org1() {
    ...
    # export CORE_PEER_MSPCONFIGPATH=${PWD}/artifacts/channel/crypto-config/peerOrganizations/customer.ibo.com/peers/peer0.customer.ibo.com/msp
...
setGlobalsForPeer0Org2() {
    ...
    export CORE_PEER_MSPCONFIGPATH=${PWD}/artifacts/channel/crypto-config/peerOrganizations/org2.ibo.com/users/Admin@org2.ibo.com/msp
...
installChaincode() {
    ...
    # setGlobalsForPeer1Org1
    # peer lifecycle chaincode install ${CC_NAME}.tar.gz
    # echo "===================== Chaincode is installed on peer1.customer ===================== "
...
# --peerAddresses peer0.customer.ibo.com:7051 --tlsRootCertFiles $PEER0_ORG1_CA --peerAddresses peer0.org2.ibo.com:9051 --tlsRootCertFiles $PEER0_ORG2_CA
...
commitChaincodeDefination() {
    setGlobalsForPeer0Org1
    peer lifecycle chaincode commit -o localhost:7050 --ordererTLSHostnameOverride orderer.ibo.com \
...
chaincodeInvoke() {
    # setGlobalsForPeer0Org1
    # peer chaincode invoke -o localhost:7050 --ordererTLSHostnameOverride orderer.ibo.com \
