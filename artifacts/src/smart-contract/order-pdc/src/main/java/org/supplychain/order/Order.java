...
public class Order {
    ...
    public String toString() {
        return "OrderDetails{" + "orderId='" + orderId + '\'' + ", initiatorOrgName='" + initiatorOrgName + '\''
                + ", approverOrgName='" + approverOrgName + '\'' + ", initiatorOrgApprovalStatus='"
                + initiatorOrgApprovalStatus + '\'' + ", approverOrgApprovalStatus='" + approverOrgApprovalStatus + '\''
                + ", payload='" + payload + '\'' + ", publishedDate='" + publishedDate + '\'' + ", lastUpdated='"
                + lastUpdated + '\'' + ", commentList=" + commentList + ", orderLastUpdatedByOrgName='"
                + orderLastUpdatedByOrgName + '\'' + ", orderType='" + orderType + '\'' + ", fileList=" + fileList
                + ", orderDate='" + orderDate + '\'' + ", approvalNeededForOrgName='" + approvalNeededForOrg + '\''
    ...
    public static Order fromJSONString(String json) {
        Order asset = geson.fromJson(json, Order.class);
        return asset;
    }
}
